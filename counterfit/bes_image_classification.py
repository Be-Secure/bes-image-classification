...
class Bes_image_classification(CFTarget):
    ...
    endpoint = f"counterfit/targets/bes_image_classification/bes_image_classification.h5"
    ...
    def load(self):
        ...
        self.model.save("./counterfit/targets/bes_image_classification/modified_bes_image_classification.h5")
